    ...
    return (
        <Container>
            <div className={styles.cars__form}>
                <form id='form-container' style={{ zIndex: isSearch ? 100 : 2 }} className={styles.form__container}>
                    <div className={styles.form__box}>
                        ...
                        <div className={styles.form__box__input}>
                            ...
                            <select
                                ...
                                name='driver'
                                id='driver'>
                                <option className='select-placeholder'>Pilih Tipe Driver</option>
                    ...
                    <div className={styles.form__box}>
                        ...
                        <div className={styles.form__box__input}>
                            <img src='./images/clock_input.svg' alt='' srcSet='' id='img-placeholder' />
                            <select
                                onClick={() => dispatch(searchMode(true))}
                                value={input.time}
                                onChange={handleChange}
